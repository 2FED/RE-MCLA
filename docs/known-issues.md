...
| KI-004 | S2 | Open | MCLA-R currently requires its pinned ReXGlue v0.9.0.2 fork for valid FLOAT16_4 mask-3 codegen diagnostics and Unicode-safe Windows host paths. | The submodule pin is automatic; do not replace it with upstream v0.9.0 or unpinned `main`. | SDK/upstream |
