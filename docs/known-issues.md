...
| KI-002 | S1 | Open | ReXGlue feasibility for this exact XEX has not been measured. | Complete M2 before runtime claims; M1 only proved the installed SDK/toolchain and source gates. | M2 |
