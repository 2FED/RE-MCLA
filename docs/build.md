...
The verified v0.9.0.26 Windows build uses:

- ReXGlue 0.9.0.26 project fork, based on upstream v0.9.0, with the exact nested dependencies in `docs/rexglue-sdk.md`
...
The presets pin the installed project-fork SDK at ReXGlue `0.9.0.26`. After successful non-force codegen, verify the ignored corpus, configure, build, and verify the Release integration with:
