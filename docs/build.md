...
The first status line must contain ReXGlue project-fork commit `6f2a0f36c153495711a5c66487064ed86f6bb614`; no line may begin with `-`, `+`, or `U`.

The verified v0.9.0.15 Windows build uses:

- ReXGlue 0.9.0.15 project fork, based on upstream v0.9.0, with the exact nested dependencies in `docs/rexglue-sdk.md`
...
The presets pin the installed project-fork SDK at ReXGlue `0.9.0.15`. After successful non-force codegen, verify the ignored corpus, configure, build, and verify the Release integration with:
