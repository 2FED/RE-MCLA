...
The first status line must contain ReXGlue project-fork commit `218b7750d4c848c9b35d371bf78dd6c26ab93398`; no line may begin with `-`, `+`, or `U`.

The verified v0.9.0.16 Windows build uses:

- ReXGlue 0.9.0.16 project fork, based on upstream v0.9.0, with the exact nested dependencies in `docs/rexglue-sdk.md`
...
The presets pin the installed project-fork SDK at ReXGlue `0.9.0.16`. After successful non-force codegen, verify the ignored corpus, configure, build, and verify the Release integration with:
