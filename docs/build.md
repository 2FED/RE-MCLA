...
The verified v0.10.0.0 Windows build uses:

- ReXGlue 0.10.0.0 project fork, based on upstream v0.9.0, with the exact nested dependencies in `docs/rexglue-sdk.md`
...
The presets pin the installed project-fork SDK at ReXGlue `0.10.0.0`. After successful non-force codegen, verify the ignored corpus, configure, build, and verify the Release integration with:
