...
The first status line must contain ReXGlue project-fork commit `3d18779d194acd57ab5e61034e9576d1fda61f6a`; no line may begin with `-`, `+`, or `U`.

The verified v0.9.0.14 Windows build uses:

- ReXGlue 0.9.0.14 project fork, based on upstream v0.9.0, with the exact nested dependencies in `docs/rexglue-sdk.md`
...
The presets pin the installed project-fork SDK at ReXGlue `0.9.0.14`. After successful non-force codegen, verify the ignored corpus, configure, build, and verify the Release integration with:
