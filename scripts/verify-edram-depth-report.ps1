...
function Assert-SourceContract {
    ...
    & git -C (Join-Path $repo 'third_party/rexglue-sdk') diff --quiet v0.9.0.18 v0.9.0.20 -- include/rex/graphics/d3d12/render_target_cache.h src/graphics/d3d12/render_target_cache.cpp src/graphics/pipeline/render_target/cache.cpp src/graphics/trace_player.cpp
