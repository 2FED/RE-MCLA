...
$sdkHead=(& git -C (Join-Path $repo 'third_party/rexglue-sdk') rev-parse HEAD).Trim();if($LASTEXITCODE-ne0-or$sdkHead-cne'c4aa30c35386bb4d2ef051a59ea8e71bab667172'){throw 'Current SDK commit identity mismatch.'}
