...
$sdkHead=(& git -C (Join-Path $repo 'third_party/rexglue-sdk') rev-parse HEAD).Trim();if($LASTEXITCODE-ne0-or$sdkHead-cne'3ef5b4f143d56b57e3c0e539cb0009ffe3a67e05'){throw 'Current SDK commit identity mismatch.'}
